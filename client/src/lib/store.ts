...
const initialAirlines: Airline[] = [
  { id: '1', name: 'Air India', code: 'AI', logo: '🇮🇳' },
  { id: '2', name: 'IndiGo', code: '6E', logo: '✈️' },
  { id: '3', name: 'Vistara', code: 'UK', logo: '🌟' },
  { id: '4', name: 'SpiceJet', code: 'SG', logo: '🌶️' },
  { id: '5', name: 'SkyWings Airlines', code: 'SW', logo: '✈️' },
];
...
const initialAirports: Airport[] = [
  ...
  { id: '9', name: 'Indira Gandhi International', code: 'DEL', city: 'New Delhi', country: 'India' },
  { id: '10', name: 'Chhatrapati Shivaji Maharaj', code: 'BOM', city: 'Mumbai', country: 'India' },
  { id: '11', name: 'Kempegowda International', code: 'BLR', city: 'Bengaluru', country: 'India' },
  { id: '12', name: 'Chennai International', code: 'MAA', city: 'Chennai', country: 'India' },
];
